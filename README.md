...
6. Open a second terminal, npm install and then npm start from your 'react-app' directory.
...
| `heroku run -a <app name>` | Run a command from within the deployed container on Heroku |# BeachChair
